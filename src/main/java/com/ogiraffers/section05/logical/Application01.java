...
public class Application01 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("true 와 fasle의 논리 and 연산 :" + (true && false));
        System.out.println("false 와 true의 논리 and 연산 :" + (false && true));
        System.out.println("false 와 false의 논리 and 연산 :" + (true && false));
        System.out.println("===================================");

        System.out.println("true 와 true의 논리 or 연산 :" + (true || true));
        System.out.println("true 와 fasle의 논리 or 연산 :" + (true || false));
        ...
        System.out.println("true 의 논리 not 연산 :" + (!false));
